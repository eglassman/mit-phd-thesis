...
The challenge of scaling up computer science education is usually framed as redressing the problems of large class sizes. This thesis, however, explores how the volume of students and their solutions can be exploited to enable new types of rapid personalized feedback, as well as recover aspects of a traditional small class. Specifically, this thesis explores how {\it clustering and visualizing solution variation} collected from \todo{massive was removed based on Rob's comment on my NEML poster}programming courses can help teachers gain insights into student design choices, detect autograder failures, award partial credit\todo{faster?}, use targeted learnersourcing to collect hints for other students, and give personalized style feedback at scale.
