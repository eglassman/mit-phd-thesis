...
\end{enumerate}
The answers to these questions could fuel instruction that complies with variation theory's recommendations. With OverCode, Foobaz, and the targeted learnersourcing workflows, I try to answer the same questions for students tackling the same programming problem.
