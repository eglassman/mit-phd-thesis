...
Unlike corpora of open source projects, it is often not difficult to go beyond static analysis and perform dynamic analyses while executing each solution in the corpus. A set of teacher-designed tests of expected behavior may already exist, some available to students while developing their solutions, some hidden from students, and some generated on the fly, through fuzz testing \cite{fuzztesting}. %As a result, these solutions can be analyzed on both their syntactic and behavioral qualities.
