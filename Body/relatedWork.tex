...
%Some methods incorporate techniques that anticipate outliers and attempt to be robust to them.
...
%One aspect of clustering that does not fall into the traditional conversation about features, distance functions, and methods is {\it interpretability}.
